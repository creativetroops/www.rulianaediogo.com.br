...
routes.post('/send-contact', (req, res) => { SendMailController.sendContact(req, res) })
routes.post("/send-rsvp",    (req, res) => { SendMailController.sendRsvp(req, res) })
routes.get ("/ping",         (req, res) => { res.send("new pong 7-11") })
routes.use((req, res) => { res.json({ message: "There is nothing here!" })})
